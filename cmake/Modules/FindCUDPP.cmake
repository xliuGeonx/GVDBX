...
if ( NOT DEFINED CUDPP_ROOT_DIR )
  SET(CUDPP_ROOT_DIR ${CONTRIB_ROOT_DIR}/cudpp)
...
if ( CUDPP_ROOT_DIR )
    ...
    #-------- Locate Library	
	if (WIN32)
		message ( STATUS "  Locating: cudpp_${MSVC_VERSION}x64.lib, MSVC: ${MSVC_VERSION}" )
	else()
		message ( STATUS "  Locating: libcudpp_${CUDA_SUFFIX}.so, CUDA: ${CUDA_SUFFIX}")
	endif()
     set ( OK_REL "0" )		
  	_FIND_FILE ( LIB1_REL CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}x64.lib" "libcudpp_${CUDA_SUFFIX}.so" OK_REL)  
  	_FIND_FILE ( LIB2_REL CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}x64.lib" "libcudpp_hash_${CUDA_SUFFIX}.so" OK_REL )	

     set ( OK_DBG "0" )	
	_FIND_FILE ( LIB1_DEBUG CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}x64d.lib" "libcudpp_${CUDA_SUFFIX}d.so" OK_DBG )	        	
	_FIND_FILE ( LIB2_DEBUG CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}x64d.lib" "libcudpp_hash_${CUDA_SUFFIX}d.so" OK_DBG  )

	#--------- Locate DLLS		
	if (OK_REL EQUAL 2)
		message ( STATUS "  Found LIBs (Release): ${LIB1_REL} ${LIB2_REL}" )	   
		set (OK_DLL "0")
		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}x64.dll" "libcudpp_${CUDA_SUFFIX}.so" OK_DLL)   
		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}x64.dll" "libcudpp_hash_${CUDA_SUFFIX}.so" OK_DLL)  
	endif()
	if (OK_DBG EQUAL 2)
		message ( STATUS "  Found LIBs (Debug): ${LIB1_DEBUG} ${LIB2_DEBUG}" )	   
		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_${MSVC_VERSION}x64d.dll" "libcudpp_${CUDA_SUFFIX}d.so" OK_DLL)   
		_FIND_FILE( CUDPP_DLL CUDPP_LIB_DIR "cudpp_hash_${MSVC_VERSION}x64d.dll" "libcudpp_hash_${CUDA_SUFFIX}d.so" OK_DLL)   
	endif()
